...
from .material_tools import register_material_tools  # Contains stub implementations (no URP functionality)
...
def register_all_tools(mcp):
    ...
    register_material_tools(mcp)  # Registers stub implementations that return friendly error messages
