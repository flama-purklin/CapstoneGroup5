...
public class TrainCarSaver : MonoBehaviour
{
    ...
    public TMP_InputField fileNameField, pathField, rowField, columnField;
    ...
    void Start()
    {
       ...
       //rowField.onValueChanged.AddListener(setRows);
       //columnField.onValueChanged.AddListener(setColumns);
    }
